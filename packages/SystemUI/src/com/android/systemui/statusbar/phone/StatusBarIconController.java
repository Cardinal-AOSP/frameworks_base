...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        mCardinalLogo = (ImageView) statusBar.findViewById(R.id.cardinal_logo);
    ...
    public void hideNotificationIconArea(boolean animate) {
        ...
        if (Settings.System.getInt(mContext.getContentResolver(),
           ...
           animateHide(mCardinalLogo, animate);
        }
    }
    ...
    private void applyIconTint() {
        ...
        mCardinalLogo.setImageTintList(ColorStateList.valueOf(mIconTint));
    }
