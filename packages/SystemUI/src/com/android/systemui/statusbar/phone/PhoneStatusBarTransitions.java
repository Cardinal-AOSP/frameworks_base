...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mNetworkTraffic, mCardinalLogo;
    ...
    public void init() {
        ...
        mCardinalLogo = mView.findViewById(R.id.cardinal_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mCardinalLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mCardinalLogo.setAlpha(newAlphaBC);
        }
    }
}
