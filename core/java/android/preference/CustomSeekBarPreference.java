...
public class CustomSeekBarPreference extends Preference implements
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        final TypedArray typedArray = getContext().obtainStyledAttributes(
                attrs, com.android.internal.R.styleable.SeekBarPreference);

        mMaxValue = attrs.getAttributeIntValue(ANDROIDNS, "max", 100);
        mMinValue = attrs.getAttributeIntValue(ANDROIDNS, "min", 0);
        mDefaultValue = attrs.getAttributeIntValue(ANDROIDNS, "defaultValue", -1);
        mUnitsLeft = getAttributeStringValue(attrs, ANDROIDNS, "unitsLeft", "");
        String units = getAttributeStringValue(attrs, ANDROIDNS, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, ANDROIDNS, "unitsRight", units);

        Integer id = typedArray.getResourceId(
                com.android.internal.R.styleable.SeekBarPreference_unitsRight, 0);
        if (id > 0) {
            mUnitsRight = getContext().getResources().getString(id);
        }
        id = typedArray.getResourceId(
                com.android.internal.R.styleable.SeekBarPreference_unitsLeft, 0);
        if (id > 0) {
    ...
    protected View onCreateView(ViewGroup parent){
        ...
        try {
            ...
            layout = (RelativeLayout)mInflater.inflate(
                    com.android.internal.R.layout.seek_bar_preference, parent, false);
    ...
    public void onBindView(View view) {
        ...
        try
        {
            ...
            ViewGroup newContainer = (ViewGroup) view.findViewById(
                    com.android.internal.R.id.seekBarPrefBarContainer);
    ...
    protected void updateView(View view) {
        ...
        try {
            ...
            mStatusText = (TextView)layout.findViewById(
                    com.android.internal.R.id.seekBarPrefValue);
            mStatusText.setText(String.valueOf(mCurrentValue));
            mStatusText.setMinimumWidth(30);
            mSeekBar.setProgress(mCurrentValue - mMinValue);

            TextView unitsRight = (TextView)layout.findViewById(
                    com.android.internal.R.id.seekBarPrefUnitsRight);
            unitsRight.setText(mUnitsRight);
            TextView unitsLeft = (TextView)layout.findViewById(
                    com.android.internal.R.id.seekBarPrefUnitsLeft);
